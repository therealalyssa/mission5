    ...
    <div className="options">
      <table>
        ...
        <tr className="border-top">
          <td></td>
          <td>
            <a id="test" href="https://content.tgstatic.co.nz/webassets/globalassets/terms-and-conditions/turners-third-party-fire-and-theft-policy-wording-0622.pdf" download="myimage" className="download2"><img src={String(download)} alt="tick" /></a>
          ...
          <td>
            <a id="test" href="https://content.tgstatic.co.nz/webassets/globalassets/terms-and-conditions/turners-third-party-fire-and-theft-policy-wording-0622.pdf" download="myimage"><img src={String(download)} alt="tick" /></a>
